...
const LanguageSwitcher = ({
    ...
    return (
        <div
            ...
            } cursor-pointer inline-flex items-center justify-center  h-12 rounded-md border border-indigo-600 bg-indigo-600 px-4 py-2 text-white font-semibold shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500`}
        >
            <button
